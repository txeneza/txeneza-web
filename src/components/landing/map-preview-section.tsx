...
export const MapPreviewSection: React.FC = () => {
  ...
  return (
    <section id="mapa-preview" className="py-20 md:py-28 bg-slate-900 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-slate-455 mt-4 text-sm sm:text-base leading-relaxed">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex p-1.5 rounded-2xl bg-slate-950/80 border border-slate-800 shadow-xl">
            <button
              onClick={() => {
                setMapMode("markers");
                setSelectedPin(null);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between gap-6">
            <div className="p-6 sm:p-8 rounded-3xl bg-slate-950/50 border border-slate-850 flex flex-col gap-5">
              ...
              <AnimatePresence mode="wait">
                {mapMode === "markers" ? (
                  ...
                  >
                    <h3 className="text-xl font-bold text-white">Mapa de Marcadores</h3>
                  ...
                  <motion.div
                    ...
                    className="flex flex-col gap-3"
                  >
                    <h3 className="text-xl font-bold text-white">Zonas Críticas</h3>
                    <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
          ...
          <div className="lg:col-span-8 bg-slate-950 rounded-3xl border border-slate-800 overflow-hidden flex flex-col h-[480px] sm:h-[520px] shadow-2xl relative">
            
            {/* Map Header Panel */}
            <div className="px-5 py-3.5 bg-slate-900 border-b border-slate-850 flex items-center justify-between text-xs font-semibold">
              ...
              <AnimatePresence>
                {selectedPin !== null && (
                  <motion.div
                    ...
                    exit={{ y: 20, opacity: 0 }}
                    className="absolute bottom-6 left-6 right-6 bg-slate-900/95 backdrop-blur-md border border-slate-800 p-4 rounded-2xl shadow-2xl z-50 flex flex-col gap-3"
                  >
                    {(() => {
                        ...
                        <>
                          <div className="flex justify-between items-start">
                            <div className="flex gap-2.5 items-center">
                              ...
                              <div>
                                <h4 className="font-extrabold text-sm text-white">{pin.title}</h4>
                                <span className="text-[10px] text-slate-400">Bairro: {pin.bairro}</span>
                              </div>
                            </div>
                            <button
                              onClick={() => setSelectedPin(null)}
                              className="text-[10px] text-slate-400 hover:text-white px-2 py-0.5 bg-slate-800 rounded-md transition-colors"
                            >
                              Fechar
                            </button>
                          </div>
                          <p className="text-xs text-slate-350 leading-relaxed">{pin.desc}</p>
