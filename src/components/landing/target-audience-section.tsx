...
export const TargetAudienceSection: React.FC = () => {
  ...
  return (
    <section id="para-quem-e" className="py-20 md:py-28 bg-slate-950 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {groups.map((group, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-slate-900/50 border border-slate-850 hover:border-limeGreen/20 rounded-3xl p-8 relative flex flex-col justify-between group transition-all duration-300"
              >
                <div>
                  {/* Header */}
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-12 h-12 rounded-2xl bg-slate-950 flex items-center justify-center text-limeGreen border border-slate-800 group-hover:scale-110 transition-transform">
                      <Icon className="w-6 h-6" />
                    </div>
                  </div>

                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-limeGreen transition-colors">
                    {group.title}
                  </h3>
                ...
                {/* Subtag */}
                <div className="pt-4 border-t border-slate-950 flex justify-between items-center text-[10px] text-slate-500 font-bold uppercase tracking-wider">
                  <span>Papel</span>
        ...
        >
          ...
          <div className="text-left">
            <h4 className="font-extrabold text-sm text-slate-200">Abordagem Inclusiva e Centrada no Cidadão</h4>
