              ...
              <div className="relative flex items-center bg-slate-950 border border-slate-800 rounded-2xl px-4 py-3 shadow-lg hover:border-limeGreen/30 transition-all">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <option value="https://github.com/txeneza/txeneza-mobile/releases/download/latest/txeneza-arm64-v8a.apk" className="bg-slate-950 text-white">
                      Android ARM64-v8a (Celulares modernos)
                    </option>
                    <option value="https://github.com/txeneza/txeneza-mobile/releases/download/latest/txeneza-armeabi-v7a.apk" className="bg-slate-950 text-white">
                      Android ARMeabi-v7a (Celulares antigos)
                    </option>
                    <option value="https://github.com/txeneza/txeneza-mobile/releases/download/latest/txeneza-x86_64.apk" className="bg-slate-950 text-white">
