...
export const TimelineAreaChart: React.FC<TimelineAreaChartProps> = ({ data }) => {
  ...
  return (
    <div className="p-6 bg-light-background dark:bg-grey900/60 backdrop-blur-md border border-grey200 dark:border-grey800/80 rounded-2xl shadow-sm h-[320px] flex flex-col col-span-1 md:col-span-2">
