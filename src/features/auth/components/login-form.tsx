...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[420px] bg-forestGreen/10 backdrop-blur-xl border border-forestGreen/30 rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden transition-all duration-300 hover:border-limeGreen/30">
      ...
      {/* Error Banner */}
      {error && (
        <div className="mb-6 p-4 rounded-xl bg-red-950/30 border border-red-500/20 flex gap-3 items-start text-xs text-red-400 animate-fadeIn">
      ...
      <form onSubmit={handleLoginSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs font-bold text-grey300 uppercase tracking-wider">
            Endereço de E-mail
          </label>
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-grey600 group-focus-within:text-limeGreen transition-colors">
